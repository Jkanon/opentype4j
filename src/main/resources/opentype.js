...
(function (global, factory) {
    ...
    function getUShort(dataView, offset) {
        return Number(dataView.getUint16(offset, false));
    }

    // Retrieve a signed 16-bit short from the DataView.
    // The value is stored in big endian.
    function getShort(dataView, offset) {
        return Number(dataView.getInt16(offset, false));
    }

    // Retrieve an unsigned 32-bit long from the DataView.
    // The value is stored in big endian.
    function getULong(dataView, offset) {
        return Number(dataView.getUint32(offset, false));
    }
    ...
    Parser.prototype.parseUShort = function() {
        var v = Number(this.data.getUint16(this.offset + this.relativeOffset));
    ...
    Parser.prototype.parseShort = function() {
        var v = Number(this.data.getInt16(this.offset + this.relativeOffset));
        this.relativeOffset += 2;
        return v;
    };

    Parser.prototype.parseF2Dot14 = function() {
        var v = Number(this.data.getInt16(this.offset + this.relativeOffset)) / 16384;
        this.relativeOffset += 2;
        return v;
    };

    Parser.prototype.parseULong = function() {
        var v = Number(getULong(this.data, this.offset + this.relativeOffset));
...
function byteToArrayBuffer(byteArray) {
...
(function() {
    return opentype.parse(byteToArrayBuffer($bytes));
})()
